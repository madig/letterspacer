// Copy of https://github.com/gifnksm/topological-sort-rs/blob/835ba17607190a40a46ca6c7c3684a6216db3ee7/src/lib.rs
// plus https://github.com/gifnksm/topological-sort-rs/pull/18
// plus clippy lint fixes.
...
#![cfg_attr(feature = "cargo-clippy", warn(clippy::invalid_upcast_comparisons))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::items_after_statements))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::mut_mut))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::never_loop))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::nonminimal_bool))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::option_map_unwrap_or))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::option_map_unwrap_or_else))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::option_unwrap_used))]
...
impl<T: Hash + Eq + Clone> Default for TopologicalSort<T> {
    fn default() -> Self {
        Self::new()
    }
}
